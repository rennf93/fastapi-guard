# guard/middleware_components/checks/implementations/suspicious_activity.py
...
from guard.middleware_components.checks.helpers import detect_penetration_patterns
